...
public class Person {
    ...
    public Integer getPersonpk() { return personpk; }
    public void setPersonpk(Integer personpk) { this.personpk = personpk; }

    @Basic
    @Column(name = "persontypeid")
    @NotNull(message = "نوع مشتری نمی تواند خالی باشد")
    @Max(value = 999,message = "نوع مشتری بین 1 تا 3 رقم می باشد.") // must be an integer value lower than or equal to the number in the value element.
    public Integer getPersontypeid() { return persontypeid; }
    public void setPersontypeid(Integer persontypeid) { this.persontypeid = persontypeid; }

    @Basic
    @Column(name = "typedetailid")
    @Max(value = 999,message = "انواع مشتری بین 1 تا 3 رقم می باشد.") // must be an integer value lower than or equal to the number in the value element.
    public Integer getTypedetailid() { return typedetailid; }
    public void setTypedetailid(Integer typedetailid) { this.typedetailid = typedetailid; }
    ...
    public String getNationalkey() { return nationalkey; }
    public void setNationalkey(String nationalkey) { this.nationalkey = nationalkey; }
    ...
    public String getBookserial() { return bookserial; }
    public void setBookserial(String bookserial) { this.bookserial = bookserial; }

    @Basic
    @Column(name = "bookserie")
    public String getBookserie() { return bookserie; }
    public void setBookserie(String bookserie) { this.bookserie = bookserie; }
    ...
    @Max(value = 999,message = "کد کشور بین 1 تا 3 رقم می باشد.") // must be an integer value lower than or equal to the number in the value element.
    public Integer getCountryid() { return countryid; }
    public void setCountryid(Integer countryid) { this.countryid = countryid; }

    @Basic
    @Column(name = "cityid")
    @Max(value = 999,message = "کد شهر بین 1 تا 3 رقم می باشد.") // must be an integer value lower than or equal to the number in the value element.
