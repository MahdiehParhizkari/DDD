...
public class Orderitem {
    ...
    @Override
    public int hashCode() { return Objects.hash(orderfk, productfk, quantity, price); }

    @ManyToOne
    @JoinColumn(name = "orderfk", referencedColumnName = "orderpk", nullable = false,insertable = false,updatable = false)
    @JsonIgnore
    public Order getOrderByOrderfk() { return orderByOrderfk; }
    public void setOrderByOrderfk(Order orderByOrderfk) { this.orderByOrderfk = orderByOrderfk; }
}
